...
const SubmitQuiz = ({ quiz, classId, refetch }) => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 relative shadow-xl max-w-lg mx-auto animate-fade-in">
            ...
            (option, optionIndex) => (
              <div key={optionIndex} className=" mb-3">
                <input
                  type="radio"
                  value={option}
                  {...register(`answer-${currentQuestionIndex}`, {
                    required: true,
