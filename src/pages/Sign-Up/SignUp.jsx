...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      formData.append("file", imageFile); // Use 'file' for Cloudinary
      formData.append("upload_preset", "ClassNet"); // Your Cloudinary upload preset
      ...
      // Stop loading after all operations
      setLoading(false);
    }
  };
