    ...
    if (discussion) {
      try {
        await axiosPublic.patch(
          `/discussions/${discussion._id}/incrementViews`
        );
      } catch (error) {
  ...
  const handleReplySubmit = async (data) => {
    ...
    try {
      const newReply = {
        ...
        author: {
          name: userdb?.name, // Teacher's name from userdb
          profilePic: userdb?.profileImage, // Teacher's profile image
          email: userdb?.email, // Teacher's email
        },
                  ...
                  {discussion.replies.map((reply, idx) => (
                    ...
                    >
                      <div className="flex items-center">
                        <div className="profielImage">
                          <img
                            src={reply?.author?.profilePic} // Assuming author profile image exists
                        ...
                        <div className="profielImage">
                          ...
                          <div className="mt-2 flex items-center text-sm text-gray-600">
                            <span className="mr-2">- {reply.author.name}</span>
                            <span>
