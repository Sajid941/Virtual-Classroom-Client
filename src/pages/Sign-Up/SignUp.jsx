  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (data.password === data.confirmPassword) {
        ...
        axios.post(`https://api.imgbb.com/1/upload?key=cf98fef2238d8ad79338385fc2dcc4e8`, formData, {
          headers: {
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6" action="#">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Your Name <span className="text-red-500">*</span> </label>
                    <input
                      type="text"
                      name="name"
                      id="name"
                      className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${errors.name ? "border-red-500" : ""} `}
                      placeholder="Jhon Doe"
                      {...register("name", { required: true })}
                    />
                    {errors.email && <span className="mt-2 ml-2 text-xs text-red-600">Email is required</span>}
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      name="email"
                      id="email"
                      className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${errors.email ? "border-red-500" : ""}`}
                  ...
                  <div>
                    <label htmlFor="role" className="block mb-2 text-sm font-medium text-gray-900">Join As <span className="text-red-500">*</span> </label>
                    <select
                      id="role"
                      name="role"
                      {...register("role", { required: "Role is required" })}
                      className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${errors.role ? "border-red-500" : ""
                        }`}
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="password"
                      placeholder="••••••••"
                      className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${errors.password ? "border-red-500" : ""} `}
                  ...
                  <div>
                    <label htmlFor="confirm-password" className="block mb-2 text-sm font-medium text-gray-900">Confirm password <span className="text-red-500">*</span> </label>
                    <input
                      type="password"
                      name="confirmPassword"
                      id="confirm-password"
                      placeholder="••••••••"
                      className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${errors.confirmPassword ? "border-red-500" : ""}`}
                      {...register("confirmPassword", { required: true })}

                    />
                    {errors.confirmPassword && <span className="mt-2 ml-2 text-xs text-red-600">Confirm Password is required</span>}
